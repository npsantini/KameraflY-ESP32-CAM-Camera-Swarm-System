        ...
        <div class="container-fluid">
            <div class="px-lg-5">
                ...
                <div class="row">
                    ...
                    $numImages = count($imag);
                    $captureNum = null;
                    $nextCaptureNum = null;
                    
                    for($currentCaptureNum = 1; $currentCaptureNum < 500; $currentCaptureNum++){
                        $imgNum = 0;
 
                        echo "<div class='row'>
                                <div class='col-xl-12 col-lg-12 col-md-12 mb-4 mt-4'>
                                    <div class='bg-white rounded shadow-sm p-2'>
                                        <h4>Capture #: ",$currentCaptureNum,"</h4>
                                    </div>
                                </div>
                            </div>
                            <div id='capture",$currentCaptureNum,"' class='row moduleImageContainer'>
                        ";
                        while ($imgNum != $numImages){
                            $captureNum = $imag[$imgNum];
                            $captureNum = strrev($captureNum);
                            $captureNum = substr($captureNum, 4);
                            $captureNum = strtok($captureNum, " ");
                            $captureNum = strrev($captureNum);

                            if ($currentCaptureNum == $captureNum) {
                                echo "<!-- Gallery item -->
                                    <div class='col-xl-3 col-lg-4 col-md-6 mb-4'>
                                        <div class='bg-white rounded shadow-sm'>
                                            <a href='https://camerafly.app/images/",$imag[$imgNum],"' target='_blank'>
                                                <img src='https://camerafly.app/images/", $imag[$imgNum], "' alt='' class='img-fluid card-img-top'>
                                            </a>
                                            <div class='p-2'>
                                                <a href='https://camerafly.app/images/",$imag[$imgNum],"' class='text-dark' target='_blank'>", $imag[$imgNum],"</a>
                                            </div>
                                            <div class='p-2 row'>
                                                <div class='col text-center'>
                                                    <a download='",$imag[$imgNum],"' href='https://camerafly.app/images/",$imag[$imgNum],"' title='",$imag[$x],"'>
                                                        <i class='fas fa-download'></i>
                                                    </a>
                                                </div>
                                                <div class='col text-center'>
                                                    <a href='?delete=images/",$imag[$imgNum],"'>
                    ...
                    $totalModules = 16;
                    $module = 0;
                    for($modNum = 1; $modNum < $totalModules + 1; $modNum++){
                        ...
                        echo "<div class='row'>
                            ...
                            <div id='module",$modNum,"' class='row moduleImageContainer'>
                        ";
                        for($x = 0; $x < count($imag); $x++){
                            if (startsWith(strval($imag[$x]), $module)) {
                                echo "<!-- Gallery item -->
                                <div class='col-xl-3 col-lg-4 col-md-6 mb-4'>
                                    <div class='bg-white rounded shadow-sm'>
